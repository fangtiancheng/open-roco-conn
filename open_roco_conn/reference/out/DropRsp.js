System.register("chunks:///_virtual/DropRsp.ts", ["./rollupPluginModLoBabelHelpers.js", "cc", "./FightSvrProtoRetInfo.ts", "./ReadUtils.ts", "./BaseMessage.ts", "./WireType.ts", "./WriteUtils.ts"], (function(t) {
        var e, i, n, r, o, s, f, a;
        return {
            setters: [function(t) {
                e = t.inheritsLoose,
            ...
            execute: function() {
                n._RF.push({}, "4c31f7Xi1ZAtLhY6ICPYBVs", "DropRsp", void 0);
                t("DropRsp", function(t) {
                    function n() {
                        ...
                        s.readFromSlice = function(t, e) {
                            for (var i = 0; t.bytesAvailable > e; ) {
                                ...
                                switch (n >>> 3) {
                                    case 1:
                                        if (0 != i)
                                            throw new Error("Bad data format: DropRsp.retInfo cannot be set twice.");
                                        ++i,
                                            this.retInfo = new r,
