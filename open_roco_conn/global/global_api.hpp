...
public:
    ...
    static void set_main_role_info(const RoleData& role_data);
    static std::optional<RoleData> get_main_role_info();
    static void clear_main_role_info();

    static void set_want_to_scene(uint16_t scene_id, uint16_t scene_version);
    static std::optional<WantToScene> get_want_to_scene();
    static void clear_want_to_scene();
