System.register("chunks:///_virtual/DataProxy.ts", ["./rollupPluginModLoBabelHelpers.js", "cc", "./Constants.ts", "./global.ts"], (function(t) {
        var e, r, n, i;
        return {
            setters: [function(t) {
                e = t.createClass
            ...
            execute: function() {
                r._RF.push({}, "c1c19k40zpOQLrQbMxO21z4", "DataProxy", void 0);
                var o = t("DataProxy", function() {
                    function t() {
                        this._srData = void 0
                    }
                    t.init = function() {
                        t._spiritProxy = i.SysAPI.getGDataAPI().getDataProxy(n.SPIRIT_DATA)
                    }
                        ,
                        t.getLvMaxSumExp = function(e, r) {
                            if (r > 100)
                                return 0;
                            for (var n, i = t._spiritProxy.select(e), o = 0; o < t.EXPTYPE_INDEX.length; o++)
                                if (i.expType == t.EXPTYPE_INDEX[o]) {
                                    n = o;
                                    break
                                }
                            for (var a = 1, u = 1; u < r; u++)
                                a += t.EXPDATA[u - 1][n];
                            return a
                        }
                        ,
                        t.getExpPrecent = function(t, e, r) {
                            var n = r - this.getLvMaxSumExp(t, e)
                                , i = this.getNextLvMaxExp(t, e)
                                , o = Math.floor(100 * n / i);
                            return o = 0 == o ? 1 : o
                        }
                        ,
                        t.getCurrentExpString = function(t, e, r) {
                            return r - this.getLvMaxSumExp(t, e) + "/" + this.getNextLvMaxExp(t, e)
                        }
                        ,
                        t.getUpLvNeedExp = function(t, e, r) {
                            var n = r - this.getLvMaxSumExp(t, e);
                            return this.getNextLvMaxExp(t, e) - n
                        }
                        ,
                        t.getNextLvMaxExp = function(e, r) {
                            if (r >= 100)
                                return 0;
                            for (var n, i = t._spiritProxy.select(e), o = 0; o < t.EXPTYPE_INDEX.length; o++)
                                if (i.expType == t.EXPTYPE_INDEX[o]) {
                            ...
                            return t.EXPDATA[r - 1][n]
                        }
                    ;
                    var r = t.prototype;
                    return r.isButtnCanUse = function(e, r) {
                        return !(e.level >= 100) && (!(e.level + r > 100) && (n = t.getLvMaxSumExp(e.id, e.level + r),
                        this._srData.remainExp >= n - e.exp));
                        var n
                    }
                        ,
                        r.getAddExp = function(e, r) {
                            return t.getLvMaxSumExp(e.id, e.level + r) - e.exp
                        }
                        ,
                        r.getAddtoLv = function(e, r) {
                            for (var n = e.exp + r, i = t._spiritProxy.select(e.id), o = 0; o < t.EXPTYPE_INDEX.length && i.expType != t.EXPTYPE_INDEX[o]; o++)
                                ;
                            for (var a = 1; a < 100; a++)
                                if (n < t.getLvMaxSumExp(e.id, a))
                                    return a - 1;
                            return 100
                        }
                        ,
                        r.getPetEvolutionDes = function(e, r) {
                            var n = t._spiritProxy.select(e);
                            return n.evolutionLevel > 0 && n.evolutionLevel <= r ? this.getPetEvolutionDes(n.evolutionID, r) : n
                        }
                        ,
                        t.getPetDes = function(e) {
                            return t._spiritProxy.select(e)
                        }
                        ,
                        e(t, [{
                            key: "srData",
