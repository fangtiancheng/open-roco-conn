System.register("chunks:///_virtual/GetRemainExpRsp.ts", ["./rollupPluginModLoBabelHelpers.js", "cc", "./FightSvrProtoRetInfo.ts", "./ReadUtils.ts", "./BaseMessage.ts", "./WireType.ts", "./WriteUtils.ts", "./SimplePetInfo.ts"], (function(e) {
        var t, i, a, n, r, s, o, f, h;
        return {
            setters: [function(e) {
                t = e.inheritsLoose,
                    i = e.createClass
            ...
            execute: function() {
                a._RF.push({}, "53b1fYZd7FGF5dfogeUqPr+", "GetRemainExpRsp", void 0);
                e("GetRemainExpRsp", function(e) {
                    function a() {
                        ...
                        s.readFromSlice = function(e, t) {
                            for (var i = 0, a = 0, s = 0, o = 0; e.bytesAvailable > t; ) {
                                ...
                                switch (f >>> 3) {
                                    case 1:
                                        if (0 != i)
                                            throw new Error("Bad data format: GetRemainExpRsp.retInfo cannot be set twice.");
                                        ++i,
                                            this.retInfo = new n,
                                    ...
                                    case 2:
                                        var m = new h;
                                        r.readTYPE_MESSAGE(e, m),
                                            this.petInfos.push(m);
                                        break;
                                    case 3:
                                        if (0 != a)
                                            throw new Error("Bad data format: GetRemainExpRsp.remainExp cannot be set twice.");
                                        ++a,
                                            this.remainExp = r.readTYPE_UINT32(e);
                                        break;
                                    case 4:
                                        if (0 != s)
                                            throw new Error("Bad data format: GetRemainExpRsp.maxDayRemainExp cannot be set twice.");
                                        ++s,
                                            this.maxDayRemainExp = r.readTYPE_UINT32(e);
                                        break;
                                    case 5:
                                        if (0 != o)
                                            throw new Error("Bad data format: GetRemainExpRsp.maxTotalRemainExp cannot be set twice.");
                                        ++o,
