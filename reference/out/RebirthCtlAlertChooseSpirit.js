System.register("chunks:///_virtual/RebirthCtlAlertChooseSpirit.ts", ["./rollupPluginModLoBabelHelpers.js", "cc", "./ActivityAPI.ts", "./PropertyDes.ts", "./UICtlBase.ts"], (function(t) {
        var e, i, s, n, c, r, l, o;
        return {
            setters: [function(t) {
                e = t.inheritsLoose,
            ...
            execute: function() {
                n._RF.push({}, "4b471CVBqZHHYx6I2vgohvz", "RebirthCtlAlertChooseSpirit", void 0);
                t("RebirthCtlAlertChooseSpirit", function(t) {
                    function n(e, i, n, r, l) {
                        ...
                        for (var h = 0; h < 6; h++)
                            e["ctlSp" + h].on(c.TOUCH_END, o.onClick, s(o)),
                                ...
                                e["ctlSp" + h].container.clear(),
                            e["ctlSp" + h].getChildByName("txtLevel") && (e["ctlSp" + h].txtLevel.text = "性格:0"),
                            e["ctlSp" + h].getChildByName("txtPRS") && (e["ctlSp" + h].txtPRS.text = "宠物等级:0"),
                    ...
                    return o.show = function(t) {
                        ...
                        for (this.m_curIndex = -1,
                            ...
                            e < this.m_spData.length) {
                                ...
                                this.res["ctlSp" + e].getChildByName("txtLevel") && (this.res["ctlSp" + e].txtLevel.text = "性格:" + l.TEMPERS[this.m_spData[e].prs - 1]),
                                this.res["ctlSp" + e].getChildByName("txtPRS") && (this.res["ctlSp" + e].txtPRS.text = "宠物等级:" + String(this.m_spData[e].level)),
