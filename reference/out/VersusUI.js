System.register("chunks:///_virtual/VersusUI.ts", ["./rollupPluginModLoBabelHelpers.js", "cc", "./AgentNode.ts", "./PureNotificationCenter.ts", "./AppConstDef.ts", "./global.ts"], (function(t) {
        var e, i, n, s, o, r, h, c, a, u, l, _, d, f, p, g, v;
        return {
            setters: [function(t) {
            ...
            execute: function() {
                var m, C, B, y, N;
                r._RF.push({}, "6363eEPb3BC/KlC1qKqseeG", "VersusUI", void 0);
                var I = h.ccclass
                    , b = h.property
                    , w = h.menu
                    , x = (t("default", (m = w("AUI/VersusUI"),
                    C = b(c),
                I(B = m((N = e((y = function(t) {
                    function e() {
                    ...
                    return r.onLoad = function() {}
                        ...
                        r.start = function() {
                            this._ui || (this._ui = new x(this.node)),
                                this._ui.closeBtn.on(a.TOUCH_END, this.onClose, this),
                            ...
                            for (var t = 0; t < this.pveNodes.length; t++)
                                if (this.pveNodes[t]) {
                                    this.pveNodes[t].on(a.TOUCH_END, this.onOpenVersus, this);
                        ...
                        r.moveItems = function(t) {
                            ...
                            if (t) {
                                ...
                                var h = this._currentIndex - 1;
                                h >= 0 && h < this.items.length && (l(this.items[h].getComponent(u)).to(this._duration, {
                                    opacity: 0
                                }).start(),
                                    l(this.items[h]).to(this._duration, {
                                        scale: new _(.5,.5,1)
                                    }).start())
                            } else {
                                ...
                                c >= 0 && c < this.items.length) {
                                    var a = this.items[c];
                                    a.getComponent(u).opacity = 0,
                                        a.setScale(.5, .5, 1),
                                        l(a.getComponent(u)).to(this._duration, {
                                            opacity: 255
                                        }).start(),
                                        l(a).to(this._duration, {
                                            scale: new _(1,1,1)
                                        }).start()
                                }
                        ...
                        ,
                        r.onClose = function() {
                            p.sendNotification(g.NN_V_DESTORY_VERSUS_VIEW)
                        }
                        ,
                        r.onOpenVersus = function(t) {
                            switch (Number(t.currentTarget.name.substring(3))) {
                                case 1:
                                    p.sendNotification(g.NN_V_SHOW_LADDER_MATCH_VIEW);
                                    break;
                                case 2:
                                    v.showMsgBox("暂未开通，敬请期待！");
                                    break;
                                case 3:
                                    p.sendNotification(g.NN_V_SHOW_MATCH_COMBAT_VIEW);
                                    break;
                                case 4:
                                case 5:
                                default:
